...
"""
    This script counts the number of droplets on a plate and bins them by size.
    Input: CSV file containing list of ROIs generated by our analysis with ImageJ.
    Output: CSV file containing the droplet counts binned by size.
"""
...
def summarize_droplet_sizes(csv_file_path):
    """Read ImageJ data from csv and summarize according to droplet size."""
    # image title
